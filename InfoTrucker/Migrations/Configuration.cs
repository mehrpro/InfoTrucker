...
namespace InfoTrucker.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<InfoTrucker.Models.AppDbContext>
    {
        ...
        protected override void Seed(InfoTrucker.Models.AppDbContext context)
        {
            ...
            menuGroup.Add(new MenuGroup() { GroupID = 1, MenuGroupTitle = "DocumentRibbonPage", Description = "اسناد" });
            menuGroup.Add(new MenuGroup() { GroupID = 2, MenuGroupTitle = "ReportRibbonPage", Description = "گزارشات" });
            menuGroup.Add(new MenuGroup() { GroupID = 3, MenuGroupTitle = "SmsRibbonPage", Description = "سامانه پیام کوتاه" });
            menuGroup.Add(new MenuGroup() { GroupID = 4, MenuGroupTitle = "SettingRibbonPage", Description = "مدیریت نرم افزار" });
            context.MenuGroups.AddRange(menuGroup);

            IList<MenuItem> menuItems = new List<MenuItem>();
            menuItems.Add(new MenuItem() { ItemID = 1, GroupID_FK = 1, ItemTitel = "PGPerson", Description = "رانندگان انجمن" });
            menuItems.Add(new MenuItem() { ItemID = 2, GroupID_FK = 1, ItemTitel = "PGPerson2", Description = "پایانه های نوبت دهی" });
            menuItems.Add(new MenuItem() { ItemID = 3, GroupID_FK = 2, ItemTitel = "PGReports", Description = "گزارشات" });
            menuItems.Add(new MenuItem() { ItemID = 4, GroupID_FK = 2, ItemTitel = "PGBillReports", Description = "نوبت دهی" });
            menuItems.Add(new MenuItem() { ItemID = 5, GroupID_FK = 3, ItemTitel = "PGSendSms", Description = "پیام کوتاه" });
            menuItems.Add(new MenuItem() { ItemID = 6, GroupID_FK = 4, ItemTitel = "PGUsers", Description = "مدیریت کاربران" });
            ...
            cleams.Add(new Cleam() { ID = 4, GroupID_FK = 2, IsDelete = false, UserID_FK = 1, MenuItemID_FK = 4 });
            cleams.Add(new Cleam() { ID = 5, GroupID_FK = 3, IsDelete = false, UserID_FK = 1, MenuItemID_FK = 5 });
            cleams.Add(new Cleam() { ID = 6, GroupID_FK = 4, IsDelete = false, UserID_FK = 1, MenuItemID_FK = 6 });
